...
1. winget install --id Cloudflare.cloudflared (Windows)

2. cloudflared tunnel --url http://localhost:8000/
then create a new terminal with cloudfare open and replace the GATEPASS_BASE_URL to the URl generated by cloudflare

3. # Windows PowerShell
   $env:GATEPASS_BASE_URL="https://cluster-saturn-geneva-between.trycloudflare.com"; uvicorn app.main:app --host 0.0.0.0 --port 8000
```
